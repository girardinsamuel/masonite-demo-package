...
1. Fork the `https://github.com/girardinsamuel/masonite-demo-package` repo.
2. Clone that repo into your computer: `git clone http://github.com/your-username/masonite-demo-package.git`.
...
- When making changes to your packages you will need to uninstall the package and reinstall it with
  `pip uninstall masonite-demo-package && pip install .`
